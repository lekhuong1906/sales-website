    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between gap-4 mx-auto p-4">
            <a href="{{ route('home') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MiDien</span>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto item-center" id="navbar-default">
                <ul
                    ...
                    <li class="relative">
                        ...
                        <a href="#"
                            ...
                            <span
                                class="absolute bg-red-900 px-[6px] text-sm text-white flex items-center justify-center -top-1 -right-3 rounded-full">1</span>
                        </a>
                    </li>
                    <li class="relative">
                        <!-- Cart -->
