...
@section('content')
    <div class="mx-auto">
        ...
        <div class="flex justify-end">
            <a href="#" class="text-xl font-bold">Xem tất cả</a>
        </div>

        <div class="mx-auto text-center my-32">
            <h1 class="font-bold text-3xl text-orange-400">Về Chúng Tôi</h1>
            <h5>Cửa hàng bán thực phẩm sạch</h5>
            <p>
                Quà tặng đặc sản đậm đà hương vị quê hương và chất lượng thượng hạng từ vùng Cao Nguyên
            </p>
        </div>
